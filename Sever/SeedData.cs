...
namespace Sever
{
    public class SeedData
    {
        ...
        private static void EnsureUsers(IServiceScope scope)
        {
            ...
            var angella = userMgr.FindByNameAsync("khalil").Result;
            if (angella == null)
            {
                ...
                result =
                    userMgr.AddClaimsAsync(
                        ...
                        new Claim[]
                        {
                            new Claim(JwtClaimTypes.Name, "khalil El"),
                            new Claim(JwtClaimTypes.GivenName, "khalil"),
                            new Claim(JwtClaimTypes.FamilyName, "EL"),
